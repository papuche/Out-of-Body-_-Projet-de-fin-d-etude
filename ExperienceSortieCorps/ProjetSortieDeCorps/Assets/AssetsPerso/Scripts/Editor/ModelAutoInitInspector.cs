...
[CustomEditor (typeof(ModelAutoInit))]
public class ModelAutoInitInspector : Editor {
	GameObject modelSrc;
	GameObject modelDst;
	GameObject model;
	/*GameObject modelSrc;
	...
	public override void OnInspectorGUI(){
		model = GameObject.FindObjectOfType<ModelAutoInit>().gameObject;
